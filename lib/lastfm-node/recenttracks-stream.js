...
var RecentTracksStream = exports.RecentTracksStream = function(lastfm, user, options) {
  if (!options) options = {};
  ...
  this.parser.on("track", function(tracks) {
...
RecentTracksStream.prototype.start = function() {
  ...
  var check = function() {
    that.lastfm.readRequest(that.params, false, function(data) {
