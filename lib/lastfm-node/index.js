...
LastFmNode.prototype.read = function(method, params) {
  ...
  var signed = isSignedMethod(method);

  var connection = http.createClient(80, this.host); 
  var request = new LastFmRequest(connection, this.requestUrl(params, signed));
  if (typeof(params.handlers) == "object") {
    _(Object.keys(params.handlers)).each(function(key) {
      request.on(key, params.handlers[key]);
    });
  }
  return request;
...
LastFmNode.prototype.write = function(params, signed) {
