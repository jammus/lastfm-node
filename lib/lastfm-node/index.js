//Edited by Garrett Wilkin for path issues.
...
var LastFmSession = require('lastfm-session');
var LastFmUpdate = require('lastfm-update');
var LastFmInfo = require('lastfm-info');
